...
public class Class12_20_1_Product_OOP {
    public static void main(String[] args) {
        Product product1 = new Product("Product 1", 10.99);
        Product product2 = new Product("Product 2", 20.49, 5);
 //       Product product3 = new Product("Product 3", 5.99, 2, "Description for Product 3");
        ...
        printNonNull("Is Washable", clothing1.isAvailable());
